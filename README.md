...
**PayPoint driver for the Omnipay PHP payment library**

[Omnipay](https://github.com/thephpleague/omnipay) is a framework agnostic, multi-gateway payment
processing library for PHP 5.3+.

This package implements only PayPoint support for Omnipay 2.x Off-sites, where the customer is redirected to enter payment details
...
{
    "require": {
        "digitickets/omnipay.paypoint": "^0.*"
    }
}
```
...
```
// Gateway setup
$gateway = $this->gatewayFactory('PayPoint');
